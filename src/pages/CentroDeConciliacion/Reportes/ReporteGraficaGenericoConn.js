...
import MigaPanCentroConciliacionReportes from "components/MigaPan/CentroConciliacionReportes";
...
const ReporteGraficaGenericoConn = (props) => {
  ...
  const consultar = async () => {
    API(
      `conciliacion/solicitud/${tipoReporte}/?fechainicial=${fechaInicial}&fechafinal=${fechaFinal}`
    )
      .then((response) => {
        setSearched(true)
    ...
    <Policy policy={[]}>
      <Page>
        <MigaPan>
          <MigaPanInicio />
          <MigaPanConciliacion />
          <MigaPanCentroConciliacionReportes />
          ...
          <Card.Body>
            {searched && (
              <>
                ...
                <ExportToExcel apiData={datosTabla} fileName={`reporte_conciliacion_${tipoReporte}`} />
              </>
            )}
            {/* {datos !== "" && (
...
export default ReporteGraficaGenericoConn;
