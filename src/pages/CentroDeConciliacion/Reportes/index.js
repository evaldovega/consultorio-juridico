...
const ConciliacionReportesIndex = () => {
  const menuItems = [
    // {
          ...
          {menuItems.map((item, index) => (
            <Col xs={12} md={6} style={{ marginBottom: "20px" }}>
              <ItemModule
                ...
                title={item.title}
                link={`/centro-de-conciliacion/${item.grafica ? 'reportes_grafica' : 'reportes'}/${item.sufijo}`}
              />
            </Col>
          ))}
          {/* <Col xs={12} md={6} style={{ marginBottom: "20px" }}>
            <ItemModule
              ...
              link={`/centro-de-conciliacion/reporte-discapacidad/`}
            />
          </Col> */}
        </Row>
      </Page>
...
export default ConciliacionReportesIndex;
