...
const ReportePorDesempleo = () => {
    ...
    const consultar = async () => {
        API(`estudiantes/inscripcion/desempleados/?fechainicial=${fechaInicial}&fechafinal=${fechaFinal}`)
            .then(response => {
        ...
        <Policy policy={[]}>
            <Page>
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Por desempleo</Breadcrumb.Item>
                </Breadcrumb>
                <Card>
                    <Card.Body style={{ padding: "2.5rem" }}>
                        <h2 className="title-line">
                            <span>Cantidad de estudiantes desempleados</span>
                        </h2>
                        <Row className="mb-3">
                            <Col xs="12" md="5">
