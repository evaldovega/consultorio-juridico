...
const ReporteProfesion = () => {
    ...
    const consultar = async () => {
        API(`estudiantes/inscripcion/profesiones/?fechainicial=${fechaInicial}&fechafinal=${fechaFinal}`)
            .then(response => {
        ...
        <Policy policy={[]}>
            <Page>
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Por profesión</Breadcrumb.Item>
                </Breadcrumb>
                <Card>
                    <Card.Body style={{ padding: "2.5rem" }}>
                        <h2 className="title-line">
                            <span>Cantidad de estudiantes por profesión y rango de fechas</span>
                        </h2>
                        <Row className="mb-3">
                            <Col xs="12" md="5">
                                    ...
                                    {datos.map((el) => (
                                        <div>
                                            <div style={{
                                                ...
                                                <span>{el.nombre_profesion} {el.cantidad}</span>
                                            </div>
                                            <br />
                                        </div>
                                    ))}
