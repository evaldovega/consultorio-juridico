...
const TipoDocumentoFormulario=({id,onSaved})=>{
    ...
    return (
        <Modal visible={visible} maskClosable={false} onCancel={()=>onCancel()} footer={buttons} title={id!='' ? 'Editar tipo de documento':'Crear tipo de documento'} >
