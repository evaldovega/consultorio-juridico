...
const DepartamentoFormulario=({id,onSaved})=>{
    ...
    return (
        <Modal visible={visible} maskClosable={false} onCancel={()=>onCancel()} footer={buttons} title={id!='' ? 'Editar departamento':'Crear departamento'} >
