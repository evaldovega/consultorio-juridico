...
const MunicipioFormulario=({id,onSaved})=>{
    ...
    return (
        <Modal visible={visible} maskClosable={false} onCancel={()=>onCancel()} footer={buttons} title={id!='' ? 'Editar municipio':'Crear municipio'} >
...
export default  MunicipioFormulario