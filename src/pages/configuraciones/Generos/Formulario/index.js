...
const GeneroFormulario=({id,onSaved})=>{
    ...
    return (
        <Modal visible={visible} maskClosable={false} onCancel={()=>onCancel()} footer={buttons} title={id!='' ? 'Editar genero':'Crear genero'} >
...
export default  GeneroFormulario